...
import { useUserChallenges, useDeleteChallenge } from "@/hooks/useChallenges";
import { DeleteChallengeDialog } from "./DeleteChallengeDialog";
import { useNavigate } from "react-router-dom";
import { 
  Trophy, Users, Copy, ExternalLink, Trash2, 
...
export const MyChallengesSection = ({ onJoinChallenge }: MyChallengesSectionProps) => {
  ...
  const handleConfirmDelete = () => {
    if (challengeToDelete) {
      deleteChallenge.mutate(challengeToDelete.id, {
        onSuccess: () => {
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <Button
                          ...
                          onClick={() => handleDeleteClick(challenge.id, challenge.title)}
